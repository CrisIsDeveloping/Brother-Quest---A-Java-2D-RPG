...
public class EnemigoNightBorne extends EnemigoBase {
    ...
    // --- Estados y cuántas fotos tiene cada animación ---
    ...
    // A qué distancia nos empieza a ver el jefe
    ...
    public EnemigoNightBorne(int x, int y) {
        super(x, y);
        this.hitbox = new CajaColision(x, y, 60, 110);
        this.estadoActual = IDLE;

        // --- Ajustes de velocidad para que el jefe sea rápido ---
        this.aniSpeed = 4;
        this.velocidad = 4.6F; // Se mueve más rápido que el jugador

        // La vida y el daño del Jefe
        this.vidaMax = 2000;
        this.vida = 2000;
        this.dano = 45;
        this.xpQueDa = 500;
        ...
        this.sombraAncho = 120;     // Hacemos la sombra más ancha que su cuerpo
        this.sombraAlto = 30;       // Hacemos el óvalo un poco más gordo
        this.sombraOffsetX = -27;   // Movemos la sombra a la izquierda para centrarla
        this.sombraOffsetY = -22;   // La acomodamos en los pies
    }
    ...
    public void actualizarIA(Jugador jugador) {
        ...
        // 1. Evitamos que cambie de lado a cada rato si el jugador está muy cerca
        if (distX > 15) {
        ...
        // 2. Revisamos si el jugador está lo suficientemente cerca para pegarle
        ...
        // Hacemos que el jefe tampoco se salga de la calle
        aplicarLimitesCarril();
    }
    ...
    public void actualizar() {
        ...
        // Hacemos que la animación de quedarse quieto sea más lenta que las demás
    ...
    public boolean puedeAtacar() {
        // Solo cuenta como golpe si está en el frame 10 de la animación de ataque
    ...
    public Rectangle getAttackBox() {
        ...
        // Ponemos el área de ataque a la derecha o izquierda según a dónde mire el jefe
    ...
    public void dibujar(Graphics2D g2, int cameraX) {
        ...
        // Tamaño del jefe al dibujarlo
        int anchoDibujo = 300;
        int altoDibujo = 300;
        int dx = hitbox.x - cameraX - 120;
        int dy = hitbox.y - 135;

        // Lo volteamos si está mirando para el otro lado
        if (img != null) {
            if (mirandoIzquierda) {
        ...
        // Si tenemos puesto el F3, dibujamos las cajas rojas y amarillas
    ...
    public boolean isAnimacionMuerteTerminada() {
        return muerto && estadoActual == DEATH && aniIndex >= getSpriteAmount(DEATH) - 1;
    }
=======
package com.rpg.juego;
